...
var kek = async function(event) {
  /*
  var questionsFormArray = new FormData(form);
 questionsFormArray.append('key1', JSON.stringify({kek: 'kskls'}));
  */
...
form.setAttribute('action',"/admin/test/create");
